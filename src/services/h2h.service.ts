...
export class H2hService {
    ...
    public async pvpH2hStats(
        ...
        await gameRepo
          ...
          ).andWhere('game.tournamentId=tour.id')
            ...
            const res = {
                ...
                player1: {
                    ...
                    bestOfThreeWonPercentage: countPercentage(
                        (result.bestOfThreeWon1 + gamesResult.bestOfThreeWon1),
                        (result.bestOfThreeCount + gamesResult.bestOfThreeCount),
                    ),
                    ...
                    bestOfFiveWonPercentage: countPercentage(
                        (result.bestOfFiveWon1 + gamesResult.bestOfFiveWon1),
                        (result.bestOfFiveCount + gamesResult.bestOfFiveCount),
                    ),
                ...
                player2: {
                    ...
                    bestOfThreeWonPercentage: countPercentage(
                        (result.bestOfThreeWon2 + gamesResult.bestOfThreeWon2),
                        (result.bestOfThreeCount + gamesResult.bestOfThreeCount),
                    ),
                    bestOfThreeCount: (result.bestOfThreeCount + gamesResult.bestOfThreeCount),
                    bestOfFiveWon: (result.bestOfFiveWon2 + gamesResult.bestOfFiveWon2),
                    bestOfFiveWonPercentage: countPercentage(
                        (result.bestOfFiveWon2 + gamesResult.bestOfFiveWon2),
                        (result.bestOfFiveCount + gamesResult.bestOfFiveCount),
                    ),
                    bestOfFiveCount: (result.bestOfFiveCount + gamesResult.bestOfFiveCount),
