...
const update_stat_dto_1 = require("../modules/stat/dto/update-stat.dto");
const stat_service_1 = require("../services/stat.service");
const create_stat_dto_1 = require("../modules/stat/dto/create-stat.dto");
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], StatController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    openapi.ApiResponse({ status: 200, type: String }),
    ...
    __metadata("design:returntype", void 0)
], StatController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    openapi.ApiResponse({ status: 200, type: String }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], StatController.prototype, "remove", null);
StatController = __decorate([
    (0, common_1.Controller)('tennis/api2/stat'),
    (0, swagger_1.ApiTags)('stat'),
