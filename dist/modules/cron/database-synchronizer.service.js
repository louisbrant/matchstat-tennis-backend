...
let DatabaseSynchronizerService = class DatabaseSynchronizerService {
    constructor(connection, databaseCalculationService, GameAtpRepository, GameWtaRepository, StatAtpRepository, StatWtaRepository, RatingAtpRepository, RatingWtaRepository) {
        this.connection = connection;
        this.databaseCalculationService = databaseCalculationService;
...
], DatabaseSynchronizerService.prototype, "synchZeroProgress", null);
__decorate([
    (0, schedule_1.Cron)('0 0 4 * * 1,4'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], DatabaseSynchronizerService.prototype, "clearSequences", null);
__decorate([
    (0, schedule_1.Cron)('0 */1 * * * *'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], DatabaseSynchronizerService.prototype, "parse", null);
DatabaseSynchronizerService = __decorate([
    ...
    __param(4, (0, typeorm_2.InjectRepository)(stat_entity_1.StatAtp)),
    __param(5, (0, typeorm_2.InjectRepository)(stat_entity_1.StatWta)),
    __param(6, (0, typeorm_2.InjectRepository)(rating_entity_1.RatingAtp)),
    __param(7, (0, typeorm_2.InjectRepository)(rating_entity_1.RatingWta)),
    __metadata("design:paramtypes", [typeorm_1.Connection,
        database_calculation_service_1.DatabaseCalculationService,
